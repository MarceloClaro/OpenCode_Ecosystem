...
Fundador. Flavell (1979) estabelece a definição canônica de metacognição que fundamenta toda a arquitetura do OpenCode. A distinção entre conhecimento metacognitivo (SelfModel) e regulação metacognitiva (MetacognitiveMonitor) deriva diretamente deste artigo.}{%
\doi{10.1037/0003-066X.34.10.906}} distinguiu dois componentes que podem ser formalizados como:
