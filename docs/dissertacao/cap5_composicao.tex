...
Antes de entrar na matemática formal, convido o leitor a considerar uma analogia concreta que motivou toda esta contribuição. Imagine que você é um engenheiro civil responsável por construir um prédio. Você recebe uma planta arquitetônica que especifica:
