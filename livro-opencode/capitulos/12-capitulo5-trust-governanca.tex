...
\codigo{skills/system/academic-audit/trust\_engine.py:78-176}.
...
\codigo{specs/test\_behavioral\_autonomy.py:42-260}.
...
\item $\text{tipo} \in \{\text{sensory}, \text{short\_term},
\text{long\_term}\}$: nível de memória.
\end{itemize}
\end{definicao}
...
confiança;
\item \textbfDelta}: quantifica a melhoria (ou degradação) observada;
...
\codigo{cooperative\_governance.py:129-320}.
...
(312 CTs) pode ser executada com \lstinline{python
specs/test\_behavioral\_autonomy.py}.
\end{observacao}
