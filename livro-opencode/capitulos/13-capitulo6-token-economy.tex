...
\begin{itemize}
\item \textbf{SPEC-022 --- Token Economy Core}: define o ledger
frozen dataclass (\codigo{TokenTransaction},
\codigo{AgentAccount}), o fee market dinâmico, o mecanismo de
precificação de ações e 8 testes de desenvolvimento dirigido por
testes (TDD). Disponível em:
...
bronze/silver/gold, allowances diário e semanal, e 6 CTs.
Disponível em:
\url{https://github.com/marceloclaro/opencode-ecosystem/tree/main/specs/SPEC-023-Agent-Economics}
\item \textbf{SPEC-024 --- Audit Integration}: implementa trilha
de auditoria SHA-256, integração com Trust Engine, imutabilidade
e verificabilidade, e 4 CTs. Total de 29/29 CTs para o conjunto
SPEC-022+023+024. Disponível em:
\url{https://github.com/marceloclaro/opencode-ecosystem/tree/main/specs/SPEC-024-Audit-Integration}
\end{itemize}
...
\node[hash, below=of g1] (h0) {hash="0"};
