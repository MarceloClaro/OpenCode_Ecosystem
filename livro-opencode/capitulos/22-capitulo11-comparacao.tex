...
(Capítulo~\ref{cap:experimentacao-validacao}). No entanto, nenhuma
...
Capítulo~\ref{cap:experimentacao-validacao}: comparar não é competir, mas
...
No próximo capítulo (Capítulo~\ref{ch:conclusao}), sintetizamos a jornada
