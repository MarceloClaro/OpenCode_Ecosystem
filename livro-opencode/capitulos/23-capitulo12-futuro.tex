...
à arquitetura de agentes (Capítulo~\ref{cap:ia-agentes}), dos scanners
...
\begin{observacao}
O N4 é um horizonte de pesquisa, não um roadmap. Não há previsão de
quando --- ou se --- o \opencodeeco{} alcançará esse nível. O valor
desta seção é estabelecer um \destaque{norte conceitual} para guiar
as próximas gerações do ecossistema.
\end{observacao}
