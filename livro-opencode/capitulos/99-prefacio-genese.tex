...
\begin{itemize}
  ...
  \item \textbf{Código-fonte dos exemplos}:
        \url{https://github.com/marceloclaro/opencode-ecosystem/tree/main/exemplos}
  \item \textbf{Suítes de teste}:
        \url{https://github.com/marceloclaro/opencode-ecosystem/tree/main/tests}
  ...
  \item \textbf{Decisões arquiteturais (ADRs)}:
        \url{https://github.com/marceloclaro/opencode-ecosystem/tree/main/docs/adr}
\end{itemize}
