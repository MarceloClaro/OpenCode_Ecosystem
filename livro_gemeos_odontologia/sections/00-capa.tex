...
\begin{capa}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=north west, text width=15cm, align=left] at ($(current page.north west) + (3.2cm, -2.5cm)$) {
            ...
            {\color{blueaccent}\sffamily\fontsize{11}{13}\selectfont\bfseries\MakeUppercase{Volume 1: Odontologia e Inteligência Artificial}}
        };
        ...
        \node[anchor=north west, text width=15cm, align=left] at ($(current page.north west) + (3.2cm, -5.2cm)$) {
            ...
            {\color{fg}\sffamily\fontsize{34}{40}\selectfont\bfseries NA ODONTOLOGIA}\\[0.5cm]
            {\color{fgalt}\sffamily\fontsize{13}{16}\selectfont\bfseries Revolução, Impacto Social e o Papel dos}\\[0.1cm]
            {\color{fgalt}\sffamily\fontsize{13}{16}\selectfont\bfseries Ecossistemas Abertos de IA}
        };
