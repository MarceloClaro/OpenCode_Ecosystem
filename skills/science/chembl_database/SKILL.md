...
> **Important**: Bioactivity values come in various units (nM, ÂµM, pM). Use
...
-   `--img_format`: Output format â€” `svg` (default, vector) or `png` (raster).
...
-   `molecule` (searchable: true): Molecules/compounds â€” the primary entry point
