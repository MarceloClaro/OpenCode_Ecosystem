...
### 1. `resolve-ensembl-id` â€” Gene Symbol â†’ Ensembl ID
...
### 2. `get-tissue-expression` â€” Get Tissue Protein Levels
...
### 3. `get-subcellular-location` â€” Get Subcellular Location
...
### 4. `get-atlas-entry` â€” Get Full HPA Entry
...
### 5. `search-hpa` â€” Search by Attribute
