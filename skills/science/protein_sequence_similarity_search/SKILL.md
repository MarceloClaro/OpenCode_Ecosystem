...
4.  **`USER_EMAIL`** (optional but recommended): Recommended by the EBI for
    ...
    command â€” **substituting `ENV_FILE` with the resolved literal path to the
    `.env` file**:
...
2.  **Perform Functional Analysis:**
    ...
    *   If the results contain only UniProt accession IDs without descriptions
        ...
        top 3â€“5 hits using the **uniprot-database** skill or other appropriate
...
*   `uniprotkb` â€“ UniProt Knowledgebase (The UniProt Knowledgebase includes
    ...
    sequence
*   `uniprotkb_swissprot` â€“ UniProtKB/Swiss-Prot (The manually annotated section
    of UniProtKB): The manually curated subsection of the UniProt Knowledgebase
*   `uniprotkb_swissprotsv` â€“ UniProtKB/Swiss-Prot isoforms (The manually
...
*   `uniprotkb_reference_proteomes` â€“ UniProtKB Reference Proteomes: Taxonomic
    subset of the UniProtKB Reference Proteomes
*   `uniprotkb_trembl` â€“ UniProtKB/TrEMBL (The automatically annotated section
...
*   `uniprotkb_refprotswissprot` â€“ UniProtKB Reference Proteomes plus
    Swiss-Prot: UniProtKB Reference Proteomes plus Swiss-Prot
*   `uniprotkb_archaea` â€“ UniProtKB Archaea: Taxonomic subset of the UniProt
    Knowledgebase for archaea
*   `uniprotkb_arthropoda` â€“ UniProtKB Arthropoda: Taxonomic subset of the
    UniProt Knowledgebase for arthropoda
*   `uniprotkb_bacteria` â€“ UniProtKB Bacteria: Taxonomic subset of the UniProt
    Knowledgebase for bacteria
*   `uniprotkb_complete_microbial_proteomes` â€“ UniProtKB Complete Microbial
    Proteomes: Taxonomic subset of the UniProt Knowledgebase for complete
    microbial proteomes
*   `uniprotkb_eukaryota` â€“ UniProtKB Eukaryota: Taxonomic subset of the UniProt
    Knowledgebase for eukaryota
*   `uniprotkb_fungi` â€“ UniProtKB Fungi: Taxonomic subset of the UniProt
    Knowledgebase for fungi
*   `uniprotkb_human` â€“ UniProtKB Human: Taxonomic subset of the UniProt
    Knowledgebase for human
*   `uniprotkb_mammals` â€“ UniProtKB Mammals: Taxonomic subset of the UniProt
    Knowledgebase for mammals
*   `uniprotkb_nematoda` â€“ UniProtKB Nematoda: Taxonomic subset of the UniProt
    Knowledgebase for nematoda
*   `uniprotkb_rodents` â€“ UniProtKB Rodents: Taxonomic subset of the UniProt
    Knowledgebase for rodents
*   `uniprotkb_vertebrates` â€“ UniProtKB Vertebrates: Taxonomic subset of the
    UniProt Knowledgebase for vertebrates
*   `uniprotkb_viridiplantae` â€“ UniProtKB Viridiplantae: Taxonomic subset of the
    UniProt Knowledgebase for viridiplantae
*   `uniprotkb_viruses` â€“ UniProtKB Viruses: Taxonomic subset of the UniProt
    Knowledgebase for viruses
*   `uniprotkb_enzyme` â€“ UniProtKB Enzyme: Taxonomic subset of the UniProt
    Knowledgebase for enzymes
*   `uniprotkb_covid19` â€“ UniProtKB COVID-19: Taxonomic subset of the UniProt
    Knowledgebase for COVID-19
*   `uniref100` â€“ UniProt Clusters 100% (UniRef100): The UniProt Reference
    Clusters (UniRef) containing sequences which are 100% identical.
*   `uniref90` â€“ UniProt Clusters 90% (UniRef90): The UniProt Reference Clusters
    (UniRef) containing sequences which are 90% identical.
*   `uniref50` â€“ UniProt Clusters 50% (UniRef50): The UniProt Reference Clusters
    (UniRef) containing sequences which are 50% identical.
*   `pdb` â€“ Protein Structure Sequences (PDBe protein structure sequences):
